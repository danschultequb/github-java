...
public interface DeleteRepositoryParametersTests
{
    static void test(TestRunner runner)
    {
        runner.testGroup(DeleteRepositoryParameters.class, () ->
        {
            ...
            runner.testGroup("setOwner(String)", () ->
            {
                ...
                final Action1<String> setOwnerTest = (String owner) ->
                {
                    ...
                    {
                        final DeleteRepositoryParameters parameters = DeleteRepositoryParameters.create();
                        final DeleteRepositoryParameters setOwnerResult = parameters.setOwner(owner);
            ...
            runner.testGroup("setName(String)", () ->
            {
                ...
                final Action1<String> setNameTest = (String name) ->
                {
                    ...
                    {
                        final DeleteRepositoryParameters parameters = DeleteRepositoryParameters.create();
                        final DeleteRepositoryParameters setNameResult = parameters.setName(name);
